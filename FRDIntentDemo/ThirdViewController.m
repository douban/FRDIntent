...
- (void)dismiss:(id)sender {
  ...
  if (self.delegate) {
    ...
    [self.delegate onControllerResultWithRequestCode:self.requestCode resultCode:FRDResultCodeCanceled data:data];
  }
}
...
- (void)confirm:(id)sender {
  ...
  if (self.delegate) {
    NSDictionary *data = @{@"text": self.textField.text};
    [self.delegate onControllerResultWithRequestCode:self.requestCode resultCode:FRDResultCodeOk data:data];
  }
}
